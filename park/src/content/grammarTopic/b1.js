    ...
    exercises: [
      {
        ...
        items: [
          { n: 1, prompt: "Ich konnte nicht kommen, ________ ich krank war. <em>(Grund, Nebensatz)</em>", answers: ["weil"], alt: ["da"] },
          { n: 2, prompt: "Es hat geregnet. ________ sind wir spazieren gegangen. <em>(Gegensatz, Adverb)</em>", answers: ["Trotzdem"], alt: ["Dennoch"] },
          ...
          { n: 8, prompt: "Ruf mich an, ________ du am Bahnhof ankommst. <em>(Zeit, künftig)</em>", answers: ["wenn"], alt: ["sobald"] },
          { n: 9, prompt: "Ich lerne jeden Tag, ________ die Prüfung zu bestehen. <em>(Zweck, gleiches Subjekt)</em>", answers: ["um"] },
          { n: 10, prompt: "Wir wohnen hier, ________ wir nach Wien gezogen sind. <em>(Zeitpunkt bis jetzt)</em>", answers: ["seit"], alt: ["seitdem"] },
        ],
      },
      {
        id: "b1neb2",
