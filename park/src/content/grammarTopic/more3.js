...
const PRAEP = {
  ...
  exercises: [
    ...
    },
    {
      id: "welche-praep",
      kind: "gap",
      title: "Übung D — Welche Präposition?",
      lede: "Bisher stand die Präposition immer schon da und du hast den Artikel gesucht. Hier ist es umgekehrt: der Artikel stimmt, die Präposition fehlt. Zu wissen, dass für den Akkusativ nimmt, hilft nichts, wenn man nach der falschen Präposition greift.",
      items: [
        { n: 1, prompt: "Ich fahre ________ dem Bus zur Arbeit.", answers: ["mit"] },
        { n: 2, prompt: "Das Geschenk ist ________ meine Schwester.", answers: ["für"] },
        { n: 3, prompt: "________ dem Essen gehen wir spazieren.", answers: ["Nach", "nach"], display: "Nach" },
        { n: 4, prompt: "Der Zug fährt ________ den Tunnel.", answers: ["durch"] },
        { n: 5, prompt: "________ meiner Oma gibt es immer Kuchen.", answers: ["Bei", "bei"], display: "Bei" },
        { n: 6, prompt: "Sie kommt ________ der Schweiz.", answers: ["aus"], why: "Herkunft, Land mit Artikel → aus" },
        { n: 7, prompt: "Ich trinke den Tee ________ Zucker — ich mag es nicht süß.", answers: ["ohne"] },
        { n: 8, prompt: "Wir sitzen alle ________ den Tisch.", answers: ["um"] },
      ],
    },
    {
      id: "seit-fuer",
      kind: "gap",
      title: "Übung E — seit oder für? aus oder von?",
      lede: "Zwei Paare, die im Englischen zusammenfallen. <b>seit</b> = etwas läuft seit damals bis jetzt (Dativ), <b>für</b> = eine geplante Dauer (Akkusativ). <b>aus</b> = heraus, Herkunft, Material; <b>von</b> = Absender, Besitzer, Ausgangspunkt.",
      items: [
        { n: 1, prompt: "Ich lerne ________ zwei Jahren Deutsch.", answers: ["seit"], why: "Es läuft immer noch → seit. Englisch „for two years“ ist hier eine Falle." },
        { n: 2, prompt: "Ich habe die Wohnung ________ ein Jahr gemietet.", answers: ["für"], why: "Geplante Dauer → für + Akkusativ." },
        { n: 3, prompt: "Das Paket ist ________ meiner Schwester.", answers: ["von"], why: "Absender → von" },
        { n: 4, prompt: "Der Ring ist ________ Gold.", answers: ["aus"], why: "Material → aus" },
        { n: 5, prompt: "Wir wohnen ________ 2019 in Wien.", answers: ["seit"] },
        { n: 6, prompt: "Sie nimmt das Buch ________ der Tasche.", answers: ["aus"], why: "Heraus aus etwas → aus" },
      ],
    },
    {
      id: "praep-saetze",
      ...
      lede: "Bau aus den Teilen einen Satz — Präposition, Fall und Wortstellung auf einmal. Sag ihn laut, dann aufdecken.",
      items: [
        { n: 1, frag: "ich · fahren · mit · der Zug · nach · Salzburg", answer: "Ich fahre <b>mit dem</b> Zug <b>nach</b> Salzburg." },
        { n: 2, frag: "wir · gehen · durch · der Park", answer: "Wir gehen <b>durch den</b> Park." },
        { n: 3, frag: "das Buch · sein · für · mein Bruder", answer: "Das Buch ist <b>für meinen</b> Bruder." },
        { n: 4, frag: "sie (Sg.) · wohnen · bei · ihre Tante", answer: "Sie wohnt <b>bei ihrer</b> Tante." },
        { n: 5, frag: "ich · kommen · aus · die Türkei", answer: "Ich komme <b>aus der</b> Türkei." },
        { n: 6, frag: "er · arbeiten · seit · ein Monat · in · Wien", answer: "Er arbeitet <b>seit einem</b> Monat in Wien.", hint: "seit nimmt den Dativ — ein Monat → einem Monat." },
        { n: 7, frag: "wir · laufen · um · der See", answer: "Wir laufen <b>um den</b> See." },
        { n: 8, frag: "nach · die Arbeit · ich · gehen · zu · der Sport", answer: "<b>Nach der</b> Arbeit gehe ich <b>zum</b> Sport.", hint: "Die Zeitangabe steht auf Position 1, also rutscht ich hinter das Verb." },
      ],
    },
  ],
  selfcheck: [
...
const PRAET = {
  ...
  exercises: [
    ...
    },
    {
      id: "sein-haben-2",
      kind: "gap",
      title: "Übung D — sein, haben, es gibt gemischt",
      lede: "Dieselben drei Verben, neue Sätze — diesmal ohne Reihenfolge.",
      items: [
        { n: 1, prompt: "Vor zehn Jahren ________ es hier noch keinen Supermarkt. <em>(geben)</em>", answers: ["gab"] },
        { n: 2, prompt: "________ ihr gestern auf der Party? <em>(sein)</em>", answers: ["Wart", "wart"], display: "wart" },
        { n: 3, prompt: "Ich ________ als Kind oft Halsschmerzen. <em>(haben)</em>", answers: ["hatte"] },
        { n: 4, prompt: "Der Kurs ________ sehr interessant. <em>(sein)</em>", answers: ["war"] },
        { n: 5, prompt: "Wir ________ gestern Besuch. <em>(haben)</em>", answers: ["hatten"] },
        { n: 6, prompt: "________ du schon mal in Salzburg? <em>(sein)</em>", answers: ["Warst", "warst"], display: "warst" },
        { n: 7, prompt: "Es ________ leider keine Karten mehr. <em>(geben)</em>", answers: ["gab"] },
        { n: 8, prompt: "Meine Eltern ________ früher ein Restaurant. <em>(haben)</em>", answers: ["hatten"] },
      ],
    },
    {
      id: "nebensatz",
      kind: "gap",
      title: "Übung E — Im Nebensatz",
      lede: "Regel 4 in Aktion: nach weil, dass und ob rutscht die Präteritumform ans Ende.",
      items: [
        { n: 1, prompt: "Ich kam nicht, weil ich arbeiten ________. <em>(müssen)</em>", answers: ["musste"] },
        { n: 2, prompt: "Sie war traurig, weil sie nicht mitfahren ________. <em>(dürfen)</em>", answers: ["durfte"] },
        { n: 3, prompt: "Wir blieben zu Hause, weil wir kein Auto ________. <em>(haben)</em>", answers: ["hatten"] },
        { n: 4, prompt: "Er sagte, dass er nicht kommen ________. <em>(können)</em>", answers: ["konnte"] },
        { n: 5, prompt: "Ich weiß, dass ihr gestern in Wien ________. <em>(sein)</em>", answers: ["wart"] },
        { n: 6, prompt: "Sie ging früh, weil sie müde ________. <em>(sein)</em>", answers: ["war"] },
        { n: 7, prompt: "Wir fragten, ob es noch Karten ________. <em>(geben)</em>", answers: ["gab"] },
        { n: 8, prompt: "Ich freute mich, weil ich endlich Urlaub ________. <em>(haben)</em>", answers: ["hatte"] },
      ],
    },
    {
      id: "wahl",
      kind: "reveal",
      title: "Übung F — Perfekt oder Präteritum?",
      lede: "Regel 1 als Entscheidung: sein, haben, Modalverben und es gibt stehen im Präteritum — alles andere im Perfekt. Sag den Satz in der Vergangenheit, dann aufdecken.",
      items: [
        { n: 1, frag: "Ich bin müde.", answer: "Ich <b>war</b> müde.", hint: "sein → Präteritum." },
        { n: 2, frag: "Ich esse eine Pizza.", answer: "Ich <b>habe</b> eine Pizza <b>gegessen</b>.", hint: "essen ist ein normales Verb → Perfekt." },
        { n: 3, frag: "Wir müssen früh aufstehen.", answer: "Wir <b>mussten</b> früh aufstehen.", hint: "Modalverb → Präteritum." },
        { n: 4, frag: "Sie fährt nach Wien.", answer: "Sie <b>ist</b> nach Wien <b>gefahren</b>.", hint: "fahren ist ein normales Verb → Perfekt, mit sein." },
        { n: 5, frag: "Es gibt ein Problem.", answer: "Es <b>gab</b> ein Problem.", hint: "es gibt → Präteritum." },
        { n: 6, frag: "Er kauft ein neues Auto.", answer: "Er <b>hat</b> ein neues Auto <b>gekauft</b>.", hint: "kaufen ist ein normales Verb → Perfekt." },
      ],
    },
  ],
  selfcheck: [
...
const REFLEX = {
  ...
  exercises: [
    ...
    },
    {
      ...
      items: [
        { n: 1, prompt: "________ Sie mir bitte helfen? <em>(können)</em>", answers: ["Könnten"] },
