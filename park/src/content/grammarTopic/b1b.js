    ...
    exercises: [
      ...
      },
      {
        ...
        items: [
          ...
          { n: 4, prompt: "Das ist der Verein. Ich bin dort Mitglied. → Das ist der Verein, ________", answers: ["in dem ich Mitglied bin"], alt: ["bei dem ich Mitglied bin", "wo ich Mitglied bin"] },
        ],
      },
    ],
    selfcheck: [
    ...
    exercises: [
      {
        ...
        items: [
          ...
          { n: 3, prompt: "________ Sie mir bitte helfen? <em>(können)</em>", answers: ["Könnten"] },
      ...
      },
      {
        ...
        items: [
          ...
          { n: 2, prompt: "Schicken Sie mir das Formular! → ________ Sie mir bitte das Formular schicken?", answers: ["Würden"], alt: ["Könnten"] },
          { n: 3, prompt: "Ich kann erst am Montag kommen. → Leider ________ ich erst am Montag kommen.", answers: ["könnte"] },
          { n: 4, prompt: "Sagen Sie mir den Termin. → ________ Sie mir bitte den Termin mitteilen?", answers: ["Könnten"], alt: ["Würden"] },
        ],
      },
    ],
    selfcheck: [
